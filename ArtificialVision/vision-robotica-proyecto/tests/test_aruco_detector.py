import unittest
from src.detectors.aruco_detector import detect_markers  # Asegúrate de que esta función exista en aruco_detector.py
...
class TestArucoDetector(unittest.TestCase):
    ...
    def test_marker_detection(self):
        ...
        markers = detect_markers(self.test_image_path)
